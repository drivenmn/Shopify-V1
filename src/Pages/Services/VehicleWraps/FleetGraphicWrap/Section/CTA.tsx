...
import { ArrowRight, Phone, Calendar, Truck, Sparkles } from 'lucide-react';
...
export function CTA({ onNavigate }: CTAProps) {
  ...
  return (
    <section className="py-32 bg-auto-asphalt relative overflow-hidden" data-section="FleetWrapsCTA">
          ...
          >
            ...
            <div className="text-center mb-16 relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-auto-plum-neon/10 border border-auto-plum-neon/30 mb-8 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-auto-plum-neon uppercase tracking-widest font-['Exo_2']">Scale Your Brand</span>
              </div>
              
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 font-['Exo_2'] uppercase tracking-tight leading-none">
                Drive Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-auto-plum-mist to-white">Business Forward</span>
              </h2>
              
              <p className="text-xl text-auto-silver max-w-3xl mx-auto leading-relaxed font-light">
                Whether you have 5 vehicles or 50, consistent branding across your fleet builds trust and authority. Let us handle your entire fleet.
              </p>
            </div>
