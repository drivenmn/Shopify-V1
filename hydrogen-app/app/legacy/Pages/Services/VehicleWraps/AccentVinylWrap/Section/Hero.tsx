...
export function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-auto-asphalt" data-section="AccentWrapsHero">
      {/* Background Parallax */}
      <div className="absolute inset-0 z-0 opacity-30">
        <motion.div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1664800527771-975403f83797?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXIlMjBibGFjayUyMHJvb2YlMjB3cmFwJTIwYWNjZW50fGVufDF8fHx8MTc3MDQ4MTA0N3ww&ixlib=rb-4.1.0&q=80&w=1080')`,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-auto-plum-deep/20 border border-auto-plum-neon/30 backdrop-blur-md">
              <Scissors className="w-4 h-4 text-auto-plum-neon" />
          ...
          >
            <span className="block text-white">Accent Wraps &</span>
          ...
          >
            It's all in the details. Customize your roof, mirrors, trim, and interior 
            to create a truly unique look that sets your vehicle apart.
          </motion.p>
