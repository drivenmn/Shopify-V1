...
export function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-auto-asphalt" data-section="FleetWrapsHero">
      {/* Background Parallax */}
      <div className="absolute inset-0 z-0 opacity-30">
        <motion.div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1716512060259-d114cfba13e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21tZXJjaWFsJTIwdmFuJTIwd3JhcCUyMGJyYW5kaW5nJTIwZmxlZXR8ZW58MXx8fHwxNzcwNDgxMDQ3fDA&ixlib=rb-4.1.0&q=80&w=1080')`,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-auto-plum-deep/20 border border-auto-plum-neon/30 backdrop-blur-md">
              <Truck className="w-4 h-4 text-auto-plum-neon" />
          ...
          >
            <span className="block text-white">Commercial Fleet</span>
          ...
          >
            Turn your fleet into 24/7 mobile billboards. 
            High-impact branding for vans, trucks, and company vehicles that drives business growth.
          </motion.p>
