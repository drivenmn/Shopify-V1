...
import { ArrowRight, Phone, Calendar, PenTool, Sparkles } from 'lucide-react';
...
export function CTA({ onNavigate }: CTAProps) {
  ...
  return (
    <section className="py-32 bg-auto-asphalt relative overflow-hidden" data-section="GraphicWrapsCTA">
          ...
          >
            ...
            <div className="text-center mb-16 relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-auto-plum-neon/10 border border-auto-plum-neon/30 mb-8 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-auto-plum-neon uppercase tracking-widest font-['Exo_2']">Get Creative</span>
              </div>
              
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 font-['Exo_2'] uppercase tracking-tight leading-none">
                Bring Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-auto-plum-mist to-white">Vision to Life</span>
              </h2>
              
              <p className="text-xl text-auto-silver max-w-3xl mx-auto leading-relaxed font-light">
                Our design team is ready to collaborate with you. From initial concept to final installation, we create custom wraps that are truly one-of-a-kind.
              </p>
            </div>
