    ...
    <section className="py-24 bg-auto-carbon relative overflow-hidden" data-section="PaintCorrectionComparison">
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          >
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(0,0,0,0.5)] text-auto-plum-deep ring-4 ring-auto-plum-neon/5 transition-transform group-hover:scale-110">
