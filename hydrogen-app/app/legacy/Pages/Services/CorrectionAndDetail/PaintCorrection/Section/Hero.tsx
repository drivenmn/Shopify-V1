...
import { Shield, ArrowRight, ChevronRight, Star, Eraser } from 'lucide-react';
...
export function Hero({ onNavigate, breadcrumbSegments }: HeroProps) {
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-auto-asphalt" data-section="PaintCorrectionHero">
      {/* Dynamic Background Image */}
      <div className="absolute inset-0 opacity-40 mix-blend-overlay">
        <motion.div 
          className="absolute inset-0" 
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1594314065604-97bfa5eb0f4d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920')`,
      ...
      >
        ...
        >
          ...
          <ChevronRight className="w-3 h-3 text-white/30" />
          <span className="text-auto-plum-neon font-medium">Paint Correction</span>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              <Eraser className="w-4 h-4 text-auto-plum-neon fill-auto-plum-neon/20" />
              <span className="text-auto-plum-mist text-xs font-bold uppercase tracking-widest font-['Exo_2']">Master Paint Correction Specialists</span>
            </motion.div>
            ...
            >
              RESTORE YOUR <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-auto-plum-neon to-white drop-shadow-[0_0_15px_rgba(157,78,221,0.5)]">SHOWROOM SHINE</span>
            </motion.h1>
            ...
            >
              Professional paint correction removes swirl marks, scratches, and oxidation to reveal a flawless finish. The ultimate preparation for ceramic coating or PPF.
            </motion.p>
            ...
            >
              {[
                { value: '95%+', label: 'Defect Removal' },
                { value: '100%', label: 'Gloss Enhancement' },
          ...
          <div className="lg:col-span-5 hidden lg:block relative">
             ...
             >
                ...
                <img 
                  src="https://images.unsplash.com/photo-1626758889762-aae1797be812?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080" 
                  alt="Car Detailing Reflection" 
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20 glass p-4 rounded-xl border border-white/10 bg-black/40 backdrop-blur-md">
                   <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-auto-plum-neon/20 flex items-center justify-center border border-auto-plum-neon/50">
                         <Star className="w-6 h-6 text-auto-plum-neon" />
                      </div>
                      <div>
                         <p className="text-white font-bold font-['Exo_2']">Mirror Finish</p>
