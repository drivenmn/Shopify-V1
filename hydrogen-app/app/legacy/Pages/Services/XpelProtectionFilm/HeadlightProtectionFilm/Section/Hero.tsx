...
import { Shield, ArrowRight, CheckCircle2, Lightbulb } from 'lucide-react';
...
export function Hero({ onNavigate }: HeroProps) {
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-auto-asphalt" data-section="HeadlightHero">
      {/* Background Parallax */}
      <div className="absolute inset-0 z-0 opacity-20">
        <motion.div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXIlMjBoZWFkbGlnaHQlMjBjbG9zZXVwfGVufDF8fHx8MTc2NDk3NDcyNXww&ixlib=rb-4.1.0&q=80&w=1080')`,
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="block text-white">XPEL Headlight</span>
          ...
          >
            Preserve your vehicle's lighting performance and aesthetics. Protect glass and polycarbonate lenses from pitting, scratching, and yellowing with professional XPEL film.
          </motion.p>
          ...
          >
            {[
              ...
              { value: '1-2 Hrs', label: 'Install Time' },
              { value: 'Zero', label: 'Yellowing' }
            ].map((stat, idx) => (
              <motion.div 
                key={stat.label}
