      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-auto-plum-neon/10 border border-auto-plum-neon/30 mb-8">
             ...
             <span className="text-xs font-bold text-auto-plum-neon uppercase tracking-widest font-['Exo_2']">Protect Your Interior</span>
           </div>

          <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 uppercase tracking-tight font-['Exo_2'] leading-none">
            Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-auto-plum-mist to-white">Protect?</span>
          </h2>
          
          <p className="text-auto-silver text-xl mb-12 max-w-2xl mx-auto font-light leading-relaxed">
             Keep your interior looking showroom new. Contact us for a quote on your specific vehicle's protection package.
          </p>
