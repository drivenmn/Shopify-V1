...
import { Home as HomeIcon, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export function Hero({ onNavigate }: HeroProps) {
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-auto-asphalt" data-section="InteriorHero">
      {/* Background Parallax */}
      <div className="absolute inset-0 z-0 opacity-20">
        <motion.div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1503376780353-7e6692767b70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBjYXIlMjBpbnRlcmlvcnxlbnwxfHx8fDE3NjQ5NzQ3MjV8MA&ixlib=rb-4.1.0&q=80&w=1080')`,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-auto-plum-deep/20 border border-auto-plum-neon/30 backdrop-blur-md">
              <HomeIcon className="w-4 h-4 text-auto-plum-neon" />
          ...
          >
            <span className="block text-white">XPEL Interior</span>
          ...
          >
            Keep your vehicle's high-gloss trim, carbon fiber, and touchscreens looking brand new. 
            XPEL Interior Protection Film heals scratches and prevents wear in high-traffic areas.
          </motion.p>
