...
export function CTA({ onNavigate }: CTAProps) {
  return (
    <section className="py-32 relative overflow-hidden bg-auto-plum-deep" data-section="MarineCTA">
      ...
      <div className="max-w-5xl mx-auto px-8 text-center relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-['Exo_2'] font-bold text-white uppercase italic mb-8 leading-tight drop-shadow-xl">
            Ready to Protect <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-auto-plum-mist">Your Vessel?</span>
          </h2>
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto font-['Inter'] font-light">
            Contact us today for a custom quote for your boat or yacht. Protect your investment with XPEL FUSION PLUS MARINE.
          </p>
