...
import { Anchor, ArrowRight, Home, ChevronRight } from 'lucide-react';
...
export function Hero({ onNavigate, breadcrumbSegments }: HeroProps) {
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-auto-asphalt" data-section="MarineCeramicHero">
      {/* Dynamic Background Image */}
      <div className="absolute inset-0 opacity-40 mix-blend-overlay">
        <motion.div 
          className="absolute inset-0" 
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1684965413057-e060f78a435d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=2070&auto=format&fit=crop')`,
      ...
      >
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              <Anchor className="w-4 h-4 text-auto-plum-neon fill-auto-plum-neon/20" />
              <span className="text-auto-plum-mist text-xs font-bold uppercase tracking-widest font-['Exo_2']">XPEL FUSION PLUS™ MARINE</span>
            </motion.div>
            ...
            >
              DEFEND AGAINST <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-auto-plum-neon to-white drop-shadow-[0_0_15px_rgba(157,78,221,0.5)]">THE ELEMENTS</span>
            </motion.h1>
            ...
            >
              FUSION PLUS® MARINE Ceramic Coating is a protective barrier designed to help prevent oxidation, corrosion, and fouling on hulls, decks, and topsides.
            </motion.p>
            ...
            >
              ...
              >
                Get Marine Quote <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
              <Button
            ...
            >
              {[
                { value: 'UV+', label: 'Protection' },
                { value: 'Salt', label: 'Resistant' },
          ...
          <div className="lg:col-span-5 hidden lg:block relative">
             ...
             >
                ...
                <img 
                  src="https://images.unsplash.com/photo-1684965413057-e060f78a435d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1587&auto=format&fit=crop" 
                  alt="Marine Ceramic Coating Application" 
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20 glass p-4 rounded-xl border border-white/10 bg-black/40 backdrop-blur-md">
                   <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-auto-plum-neon/20 flex items-center justify-center border border-auto-plum-neon/50">
                         <Anchor className="w-6 h-6 text-auto-plum-neon" />
                      </div>
                      <div>
                         <p className="text-white font-bold font-['Exo_2']">Anti-Fouling</p>
                         <div className="flex items-center gap-1 text-xs text-auto-plum-mist">
                            <span>Saltwater Corrosion Defense</span>
                         </div>
                      </div>
                   </div>
                </div>
