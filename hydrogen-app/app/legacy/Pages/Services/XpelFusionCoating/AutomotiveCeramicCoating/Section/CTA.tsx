...
export function CTA({ onNavigate }: CTAProps) {
  return (
    <section className="py-32 relative overflow-hidden bg-auto-plum-deep" data-section="CeramicCoatingCTA">
      ...
      <div className="max-w-5xl mx-auto px-8 text-center relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-['Exo_2'] font-bold text-white uppercase italic mb-8 leading-tight drop-shadow-xl">
            Protect Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-auto-plum-mist">Investment</span>
          </h2>
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto font-['Inter'] font-light">
            Professional ceramic coating installation with multi-year warranty coverage. Schedule your free consultation today.
          </p>
