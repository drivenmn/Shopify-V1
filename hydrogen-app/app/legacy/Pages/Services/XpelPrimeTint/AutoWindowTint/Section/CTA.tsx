import { GoogleReviews } from '~/legacy/components/GoogleReviews';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-exo text-white leading-[1.1]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--auto-plum-neon)] to-[var(--auto-plum-mist)]">
                  Your Ride?
                </span>
              </h2>

              <p className="text-lg text-gray-400 leading-relaxed max-w-xl">
                Experience the difference of professional XPEL window tinting. Superior heat rejection, 
                privacy, and a lifetime warranty installed by certified experts.
              </p>

              <div className="space-y-4">
                {[
                  'Precision Computer Cut Patterns',
                  'Dust-Free Climate Controlled Studio',
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                 {[
                   { label: 'Vehicles Protected', value: '5,000+' },
          ...
          <div className="text-center border-t border-white/5 pt-12">
            <p className="text-xs text-gray-600 max-w-5xl mx-auto leading-relaxed">
              Professional automotive window tinting services in Minneapolis. XPEL authorized dealer specializing 
              in ceramic window film installation for cars, trucks, SUVs, and luxury vehicles. Premium heat 
              rejection window tint with lifetime warranty. Serving Twin Cities and surrounding areas.
              Mobile window tinting available. Legal compliance guaranteed. XPEL PRIME CS, HP, XR, XR PLUS ceramic films available.
            </p>
          </div>
        </div>
      </div>
